    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#captchaImage").click(function () {//点击更换验证码
                this.src = "${pageContext.request.contextPath}/code/code/?time=" + new Date();
                /*$.ajax({
                 type:"post",
                 url:"
                ${pageContext.request.contextPath}/code/code.do",
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/code/code"
                         title="点击更换验证码"/>
                </td>
            </tr>
            <tr>
